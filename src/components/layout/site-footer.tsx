      ...
      <Container className="py-16 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.15fr_2fr] lg:gap-20">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-4 sm:gap-8">
                  ...
                  {group.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        ...
                        className="inline-flex min-h-9 items-center py-1.5 text-background/70 transition-colors hover:text-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-background"
                      >
                        {link.label}
                      </Link>
                    </li>
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-background/45">{copy.connect}</p>
              <ul className="mt-4 grid gap-1 text-sm sm:gap-3">
