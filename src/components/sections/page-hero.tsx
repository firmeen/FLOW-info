    ...
    <section className="border-b border-border bg-background">
      <Container className="py-20 sm:py-32 lg:py-40">
        <FadeIn className="max-w-5xl">
          ...
          <h1 className="mt-6 max-w-4xl text-balance text-[2.75rem] font-semibold leading-[0.98] tracking-[-0.05em] sm:text-6xl sm:leading-[1] sm:tracking-[-0.055em] lg:text-7xl">
          ...
          {quote ? (
            <p className="mt-10 max-w-3xl border-l border-foreground/20 pl-4 text-lg font-medium tracking-[-0.03em] sm:mt-12 sm:pl-5 sm:text-2xl">
